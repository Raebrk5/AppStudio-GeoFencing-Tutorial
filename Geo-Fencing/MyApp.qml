...
App {
   ...
   property string currentlayer: "pollinator_habitat"
   ...
   Page{
       ...
       contentItem: Rectangle{
           ...
           MapView{
               ...
               Map {
                   ...
                   FeatureLayer {
                       id: featureLayer_pollinatorhabitat
                       visible: True
                       ServiceFeatureTable {
                           id: pollinator_habitat
                           url: "http://services.arcgis.com/0L95CJ0VTaxqcmED/ArcGIS/rest/services/pollinator_habitat/FeatureServer/0"
                               ...
                               if (queryFeaturesStatus === Enums.TaskStatusCompleted) {
                                   ...
                                   if (templength===0){
                                       ...
                                       if (inBuilding==false && navMode!="empty") {
                                           if (activeDevice && voiceMode) {
                                               textToSpeech.say("You're entering Pollinator Habitat! Please be careful of our small friends!")
                                           } else if(activeDevice) {
                                               Vibration.vibrate();
                                           } else {
                                               console.log(notification.schedule("alert","You're entering Pollinator Habitat! Please be careful of our small friends!!", 0.1));
                                           }
                                       }
                                       inBuilding = true;
       ...
       //        }
               ...
               PolygonBuilder {
                   id: polygonBuilder
                   spatialReference: featureLayer_pollinatorhabitat.spatialReference
               }
               SimpleFillSymbol {
   ...
   function updateStatus(position) {
       if (!lastpoint && position.coordinate.latitude) {
           ...
           if (currentlayer=="pollinatorHabitat") {
